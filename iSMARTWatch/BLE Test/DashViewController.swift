...
@objc protocol DashViewControllerDelegate : Any{
    
    func dashViewControllerDidFinish(controller : DashViewController)
...
class DashViewController : UIViewController {
    ...
    @IBOutlet var delegate : DashViewControllerDelegate?
    ...
    @IBAction func done(sender : AnyObject) {
        ...
        delegate?.dashViewControllerDidFinish(self)
